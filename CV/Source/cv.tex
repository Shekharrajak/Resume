...
\section{\faGears}{Skills}
 \resumeEntryStart
  \resumeEntryS{Web Development} {Angular, NodeJS, Spring Boot, Jekyll, Hugo}
  \resumeEntryS{Database} {MySql, MongoDB}
  \resumeEntryS{DevOps} {Docker, Git, SVN, Travis, Jenkins CI/CD, , Kafka message bus}
  \resumeEntryS{Programming Languages } {C, Cpp, Java, Python, Ruby, Javascript}
